...
❓ С помощью этого бота вы можете добавить промокод используя /{text.ADMIN_NEW_PROMO}
Просмотр всех промокодов - /{text.ADMIN_LIST_PROMOS}
Удалить промокод - /{text.ADMIN_DEL_PROMO}
"""
...
CHOOSE_PROMOCODE = "🗑 <b>Выберите промокод для удаления</b>"

PROMOCODE_DOES_NOT_EXISTS = "❌ <b>Такой промокод не найден!</b>"

PROMOCODE_DELETED = "✅ <b>Промокод удален!</b>"

MESSAGE_SENDED_FOR_SUPPORT = "✔ Отправлено в поддержку"
